...
EOSQL
    ...
    class Pkginfo
      def self.pkginfo
        ...
        @pkginfo.set['rhel']['2016.09']['5.5']['client_package'] = %w(mysql-community-client mysql-community-devel)
        @pkginfo.set['rhel']['2016.09']['5.5']['server_package'] = 'mysql-community-server'
